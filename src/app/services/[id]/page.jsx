...
const CardDetails = () => {
    ...
    useEffect(() => {
        fetch(`https://pdfmagic-bice.vercel.app/api/services/${id}`) // Fetch from the public directory directly
            .then((res) => res.json())
                ...
                Drop == "true" ?
                    ...
                    <div className='my-10 md:my-40'>
                        ...
                        <div
                            ...
                            className={`w-[70%] mx-auto ${services.bgColor} ${DragOver == "true" ? "border-solid border-black bg-orange-500 border-2 rounded-md" : " border-dashed border-2 bg-slate-200 rounded-md  border-black"}   h-[300px]
